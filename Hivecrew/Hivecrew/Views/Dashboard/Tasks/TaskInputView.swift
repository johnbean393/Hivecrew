...
// MARK: - Context Suggestion Drawer

private enum PromptContextMode: String, CaseIterable {
...
private struct PromptContextSuggestion: Identifiable, Codable, Equatable {
    let id: String
...
private struct RetrievalContextPackPayload: Decodable {
    let id: String
...
@MainActor
private final class PromptContextSuggestionProvider: ObservableObject {
...
private struct ContextSuggestionDrawer: View {
