...
```bash
cd ~/Library/Application\ Support/Hivecrew/Templates; gtar --sparse -cvf - "golden-v0.0.15" | zstd -T0 -10 -o /Users/bj/Desktop/Personal/Development/Images/macOS/golden-v0.0.15.tar.zst --progress
```
...
Try:
```bash
rclone copy /Users/bj/Desktop/Personal/Development/Images/macOS/golden-v0.0.15.tar.zst cloudflare-r2:hivecrew-templates/ \
  --progress \
  --s3-chunk-size 64M \
...
```bash
rclone copy /Users/bj/Desktop/Personal/Development/Images/macOS/golden-v0.0.15.tar.zst cloudflare-r2:hivecrew-templates/ --progress
```
  ...
  "templates": [
    {
      ...
      "version": "0.0.14",
      "url": "https://templates.hivecrew.org/golden-v0.0.15.tar.zst",
...
```swift
public static let goldenV0.0.15 = RemoteTemplate(
    id: "golden-v0.0.15",
    ...
)
