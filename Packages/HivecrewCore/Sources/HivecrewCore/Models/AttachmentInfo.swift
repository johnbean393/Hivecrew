...
public struct AttachmentInfo: Codable, Hashable, Sendable {
    ...
    public static let maxCopySize: Int64 = 250 * 1024 * 1024

    /// Create attachment info for a file that was copied
    public init(originalPath: String, copiedPath: String?, fileSize: Int64) {
