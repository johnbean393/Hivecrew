...
public enum SessionTraceParser {
    public static func parseEvents(from content: String, sessionDirectory: URL? = nil) -> [TraceEventInfo] {
    ...
    public static func resolveImportedAssetPath(_ rawPath: String?, sessionDirectory: URL) -> String? {
    ...
    public static func extractEventDetails(from data: [String: Any], type: String) -> (
        summary: String,
        details: String?,
